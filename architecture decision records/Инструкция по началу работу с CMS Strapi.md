...
6. Добавление новостей.  
      6.1 В левой части экрана необходимо выбрать раздел “Новости”. После необходимо нажать на “+ Create new entry”.  

      ![strapi create news](./images/strapi-create-news.png)  

      6.2 Далее логика аналогична добавлению новой страницы.  
