...
1. [Edit]() - редактировать категорию
2. [Duplicate]() - клонировать категорию, сделать дубликат
3. [Delete entry]() - удалить категорию

Данные опции работают так же, как при работе с новостями, примеры см. по ссылкам в списке выше.

![strapi instruction strapi documents categories actions button](./images/instruction-strapi-documents-categories-actions-button.png)  
...
1. Edit - редактировать документ
2. Duplicate - клонировать документ, сделать дубликат
3. Delete entry - удалить документ
