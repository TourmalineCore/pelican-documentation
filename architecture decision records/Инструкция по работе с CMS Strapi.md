...
9. [Возможные ошибки](#errors)  
  9.1 [На frontend`е отображается 404 страница, вместо искомого контента](#errors-404-page)  
...
<h2 id="auth-in-cms">3. Авторизация в CMS:</h2>  
...
<h3 id="auth-in-cms--change-language">3.1 Смена языка интерфейса CMS</h3>  
Поле 5 позволяет выбрать язык, на котором будет отображаться интерфейс CMS (Русский/English).  

<h2 id="common-information">4. Общая информация</h2>  
<h3 id="logout">4.1 Выход из аккаунта в CMS</h3>  
...
<h3 id="draft-and-published">4.2 Черновик и опубликованная версия контента:</h3>  
...
<h3 id="preview">4.3 Предварительный просмотр:</h3>  
...
Возвращаясь к предыдущему примеру (пункт 4.2), если открыть предварительный просмотр черновика главной страницы, то мы увидим, что отображается версия контента, которая задана в черновике и которая отличается от ранее опубликованной.<br><br>
...
<h3 id="required-fields">4.4 Обязательные поля:</h3>  
...
<h3 id="upload-images">4.5 Загрузка файлов:</h3>  
...
<h2 id="edit-pages">5. Редактирование страниц</h2>  
<h3 id="add-blocks">5.1 Добавление блоков:</h3>  
...
<h3 id="kind-blocks">5.2 Виды блоков:</h3>  
...
<h2 id="header">5.3 Шапка сайта</h2>  
...
<h2 id="home-page">5.4. Главная страница</h2>

<h2 id="contact-zoo-page">5.5. Страница контактного зоопарка</h2>  

<h2 id="news-page">5.6. Страница новостей</h2>  

<h2 id="documents-page">5.7. Страница документов</h2>  
