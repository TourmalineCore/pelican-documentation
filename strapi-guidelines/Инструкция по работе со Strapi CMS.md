...
5. [Добавление, редактирование и удаление новостей](#edit-news)<br/>
    5.1 [Прикрепление VK видео в новости](#attach-vk-video)<br/>
...
<h3 id="other-page">4.9. Страница "Другое"</h3> 
...
<h3 id="attach-vk-video">5.1. Прикрепление VK видео в новости</h3>

Необходимо в VK найти видео, которые вы хотите прикрепить. Нажать правой кнопкой мыши внутри видеоплеера и в появившемся меню нажать на кнопку "Копировать код для встраивания".
...
Финальный вид скопированной ссылки - https://vk.ru/video_ext.php?oid=-71671982&id=456242156&hash=ad68b340cd8858bc

После этого это ссылку можно вставить в содержимое новости в CMS. Если вы все сделали правильно, то вместо ссылки у вас должно отобразиться точно так же как на изображении ниже. 

![attach vk video tonews](./images/attach-vk-video-to-news.png)
*Прикрепление VK видео в новость*

Если вы просто хотите прикрепить ссылку на видео без преобразования в видеоплеер, то воспользуйтесь специальной кнопкой в редакторе для прикрепления ссылок.

![attach vk video url](./images/attach-vk-video-url.png)
